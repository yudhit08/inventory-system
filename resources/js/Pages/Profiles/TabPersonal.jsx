            ...
            >
                <Formik
                    initialValues={{
                        ...
                        address:
                            "3801 Chalk Butte Rd, Cut Bank, MT 59427, United States",
                        address1:
                            "301 Chalk Butte Rd, Cut Bank, NY 96572, New York",
                        country: "US",
                        state: "California",
                        skill: [
                            "Adobe XD",
                    ...
                    validationSchema={Yup.object().shape({
                        ...
                        note: Yup.string().min(
                            150,
                            "Not shoulde be more then 150 char."
                        ),
                    })}
                    onSubmit={(
                        values,

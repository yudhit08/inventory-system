...
const Breadcrumbs = ({
    ...
    if (customLocation.includes("/pengaduan/riwayat-pengaduan/")) {
        customLocation = "/pengaduan/riwayat-pengaduan";
    }

    if (customLocation.includes("/barang/daftar-barang/")) {
        customLocation = "/barang/daftar-barang";
    }

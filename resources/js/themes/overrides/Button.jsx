    ...
    switch (variant) {
        case "contained":
            return {
                ...(color === "secondary" && {
                    backgroundColor:
                        theme.palette.mode === ThemeMode.DARK ? light : dark,
                }),
                "&:hover": {
                    backgroundColor:
                        theme.palette.mode === ThemeMode.DARK ? lighter : dark,
                    ...(color === "secondary" && {
                        backgroundColor:
        ...
        case "dashed":
            return {
                ...
                borderColor:
                    theme.palette.mode === ThemeMode.DARK ? darker : main,
        ...
        default:
            return {
                "&:hover": {
                    color:
                        theme.palette.mode === ThemeMode.DARK ? darker : dark,
                    backgroundColor:
                        theme.palette.mode === ThemeMode.DARK
                            ? lighter + 30
                            : lighter,
